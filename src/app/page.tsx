...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="hero-bg text-white relative overflow-hidden border-b-0">
        {/* Decorative elements */}
      ...
      {/* CTA Section */}
      <section className="py-24 hero-bg text-white relative overflow-hidden border-b-0">
        {/* Decorative */}
